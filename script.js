...
function callGitHub() {
    fetch('https://api.github.com/users/drammaster/repos')
        ...
        for (var i = 0; i < repos.length; i++) {
            ...
            var linker = "https://github.com/Drammaster/" + repos[i].name;
