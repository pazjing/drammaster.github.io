        ...
        .then(repos => {
            for(let i = 0; i < repos.length; i++) {
                ...
                if(rep[1] == "Python") {
                    ...
                    svg_ins = svg_angular;
                } else if (rep[1] == "TypeScript") {
                    svg_ins = svg_typescript;
                }
